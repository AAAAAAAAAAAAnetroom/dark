...
/*
原文
if (window.location.hostname !== 'netroom.oz96.com') {
...
і = ~[]; і = { ___: ++і, $$$$: (![] + "")[і], __$: ++і, $_$_: (![] + "")[і], _$_: ++і, $_$$: ({} + "")[і], $$_$: (і[і] + "")[і], _$$: ++і, $$$_: (!"" + "")[і], $__: ++і, $_$: ++і, $$__: ({} + "")[і], $$_: ++і, $$$: ++і, $___: ++і, $__$: ++і }; і.$_ = (і.$_ = і + "")[і.$_$] + (і._$ = і.$_[і.__$]) + (і.$$ = (і.$ + "")[і.__$]) + ((!і) + "")[і._$$] + (і.__ = і.$_[і.$$_]) + (і.$ = (!"" + "")[і.__$]) + (і._ = (!"" + "")[і._$_]) + і.$_[і.$_$] + і.__ + і._$ + і.$; і.$$ = і.$ + (!"" + "")[і._$$] + і.__ + і._ + і.$ + і.$$; і.$ = (і.___)[і.$_][і.$_]; і.$(і.$(і.$$ + "\"" + "\\" + і.__$ + і.$_$ + і.__$ + і.$$$$ + "\\" + і.$__ + і.___ + "(\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + "." + (![] + "")[і._$_] + і._$ + і.$$__ + і.$_$_ + і.__ + "\\" + і.__$ + і.$_$ + і.__$ + і._$ + "\\" + і.__$ + і.$_$ + і.$$_ + ".\\" + і.__$ + і.$_$ + і.___ + і._$ + "\\" + і.__$ + і.$$_ + і._$$ + і.__ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$_$_ + "\\" + і.__$ + і.$_$ + і.$_$ + і.$$$_ + "\\" + і.$__ + і.___ + "!==\\" + і.$__ + і.___ + "'\\" + і.__$ + і.$_$ + і.$$_ + і.$$$_ + і.__ + "\\" + і.__$ + і.$$_ + і._$_ + і._$ + і._$ + "\\" + і.__$ + і.$_$ + і.$_$ + "." + і._$ + "\\" + і.__$ + і.$$$ + і._$_ + і.$__$ + і.$$_ + "." + і.$$__ + і._$ + "\\" + і.__$ + і.$_$ + і.$_$ + "')\\" + і.$__ + і.___ + "{\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$$_ + і._$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$$$ + і._$_ + і.$$$_ + "\\" + і.__$ + і._$_ + і.$__ + і._$ + "(" + і.___ + "," + і.___ + ");\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + і.$$$$ + і._$ + "\\" + і.__$ + і.$$_ + і._$_ + "(\\" + і.__$ + і.$_$ + і._$_ + "=" + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і._$_ + "<" + і.$__$ + і.___ + і.___ + і.___ + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і._$_ + "++){\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + і.$$$$ + і._$ + "\\" + і.__$ + і.$$_ + і._$_ + "(\\" + і.__$ + і.$_$ + і.__$ + "=" + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "<" + і.$__$ + і.___ + і.___ + і.___ + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "++){\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$_$ + і.$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$_ + і.$$$_ + "\\" + і.__$ + і.___ + і._$_ + "\\" + і.__$ + і.$$$ + і.__$ + "(\\" + і.__$ + і.$_$ + і.__$ + "," + і.___ + ");\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "}\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + і.$$$$ + і._$ + "\\" + і.__$ + і.$$_ + і._$_ + "(\\" + і.__$ + і.$_$ + і.__$ + "=" + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "<" + і.$__$ + і.___ + і.___ + і.___ + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "++){\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$_$ + і.$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$_ + і.$$$_ + "\\" + і.__$ + і.___ + і._$_ + "\\" + і.__$ + і.$$$ + і.__$ + "(" + і.___ + ",\\" + і.__$ + і.$_$ + і.__$ + ");\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "}\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + і.$$$$ + і._$ + "\\" + і.__$ + і.$$_ + і._$_ + "(\\" + і.__$ + і.$_$ + і.__$ + "=" + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "<" + і.$__$ + і.___ + і.___ + і.___ + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "++){\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$_$ + і.$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$_ + і.$$$_ + "\\" + і.__$ + і.___ + і._$_ + "\\" + і.__$ + і.$$$ + і.__$ + "(-\\" + і.__$ + і.$_$ + і.__$ + "," + і.___ + ");\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "}\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + і.$$$$ + і._$ + "\\" + і.__$ + і.$$_ + і._$_ + "(\\" + і.__$ + і.$_$ + і.__$ + "=" + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "<" + і.$__$ + і.___ + і.___ + і.___ + і.___ + ";\\" + і.$__ + і.___ + "\\" + і.__$ + і.$_$ + і.__$ + "++){\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$_$ + і.$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$_ + і.$$$_ + "\\" + і.__$ + і.___ + і._$_ + "\\" + і.__$ + і.$$$ + і.__$ + "(" + і.___ + ",-\\" + і.__$ + і.$_$ + і.__$ + ");\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "\\" + і.$__ + і.___ + "}\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "};\\" + і.__$ + і._$_ + "\\" + і.__$ + і._$_ + "\\" + і.__$ + і.__$ + "\\" + і.__$ + і.$$_ + і.$$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$_$ + і.$$_ + і.$$_$ + і._$ + "\\" + і.__$ + і.$$_ + і.$$$ + ".\\" + і.__$ + і.$$_ + і.___ + і.$_$_ + "\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$_$ + і.$$_ + і.__ + ".\\" + і.__$ + і.$$_ + і._$_ + і.$$$_ + "\\" + і.__$ + і.$$_ + і._$$ + "\\" + і.__$ + і.$_$ + і.__$ + "\\" + і.__$ + і.$$$ + і._$_ + і.$$$_ + "\\" + і.__$ + і._$_ + і.$__ + і._$ + "(" + і.$___ + і.___ + і.___ + "," + і.$$_ + і.___ + і.___ + ");\\" + і.__$ + і._$_ + "}" + "\"")())();
...
// Cookieにdversionの値を設定する関数
function setDVersionToCookie(value) {
	document.cookie = "dversion=" + value;
}

// Cookieからdversionの値を取得する
var currentDVersion = getDVersionFromCookie();

// 条件に基づいて処理を実行する
if (currentDVersion === "") {
	setDVersionToCookie(dver);
} else if (currentDVersion !== dver) {
	setDVersionToCookie(dver);
	alert(updtmsg);
}
...
var roomDescWrap = document.getElementById("room_desc_wrap");

if (roomDescWrap) {
    var observer = new MutationObserver(function(mutationsList) {
        for(var mutation of mutationsList) {
            if (mutation.type === 'childList') {
                removeIframesAndWhitespace();
            }
        }
    });
    observer.observe(roomDescWrap, { childList: true, subtree: true });
    removeIframesAndWhitespace();
}

function removeIframesAndWhitespace() {
    var children = roomDescWrap.childNodes;
    for (var i = 0; i < children.length; i++) {
        var child = children[i];
        if (child.nodeName === 'IFRAME' || (child.nodeType === Node.TEXT_NODE && child.nodeValue.trim() === '')) {
...
function show_msg(room_id, res, ini_flag, target, nowHeight) {
	...
	for (var i = 0; i < res.length; i++) {
		if (res[i]["comment"] != undefined) {
			...
			if (ip2 === "103.5.140.150") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.15.33.17") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "124.35.139.146") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "183.90.183.210") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.7.211.97") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.51.247.161") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "140.227.204.70") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "60.157.102.79") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "60.71.186.138") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "124.35.139.146") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "133.106.128.143") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "60.67.54.133") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "60.113.57.143") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.51.245.212") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "103.5.140.186") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.227.163.6") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.40.27.120") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "103.5.140.129") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "126.7.211.97") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "133.106.134.224") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			}
			if (ip2 === "183.90.183.210") {
				var syounin = '<font color="#a0a0a0" size="1">→FFTdareka</font>';
			...
			if (ip2 === "42.151.65.250") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.194.152") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.194.234") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.194.103") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.194.174") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.194.238") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "222.230.128.87") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "106.130.195.97") {
				var syounin = '<font color="#a0a0a0" size="1">→低反発まねきねこ</font>';
			}
			if (ip2 === "58.88.192.74") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "106.154.181.218") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "59.106.228.196") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "163.43.120.116") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "163.43.244.164") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "153.175.135.211") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "58.88.192.74") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.168.216.245") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.168.77.249") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.168.221.50") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "163.43.120.116") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			...
			if (ip2 === "126.186.227.115") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "163.43.244.164") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "121.1.165.236") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.168.24.163") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "123.218.167.111") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.168.197.226") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "126.186.197.184") {
				var syounin = '<font color="#a0a0a0" size="1">→璃空</font>';
			}
			if (ip2 === "220.221.83.239") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "14.9.6.0") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			...
			if (ip2 === "219.165.229.152") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "122.131.30.0") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "111.217.253.162") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "219.165.139.151") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "14.9.20.96") {
				var syounin = '<font color="#ff31e7" size="1">→ラージ(要注意人物)</font>';
			}
			if (ip2 === "113.144.209.81") {
				var syounin = '<font color="#ff31e7" size="1">→いなみ(要注意人物)</font>';
			}
			...
			html += '<div class="comment_head"><span class="m_no">' + data["seq"] +
				...
				'</span>' + syounin + '<span class="m_time">　 ' + u_id + '</span><br></span class="m_time">　bid:' + data.bid +  '</span></div>';
...
function generateRandomString2() {
	const characters = "abcdefghijklmnopqrstuvwxyz"; // 使用する文字の範囲を指定
	...
	return generateRandomSegment(15);;
}
